export const EventCard = () => {
  return (
    <div className="event grid md:grid-cols-2 rounded-lg bg-white m-5 p-2 lg:w-3/4 w-11/12 h-fit">
      <div className="">
        <img
      ...
      <div className="event-info m-5 w-full md:text-left justify-center">
