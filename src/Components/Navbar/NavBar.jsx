...
export const NavBar = () => {
  ...
  return (
    <nav className="md:grid md:grid-cols-3 md:place-items-center items-center sticky top-0 w-full md:px-12 px-6 py-4 bg-slate-400 bg-clip-padding backdrop-filter backdrop-blur-lg border overflow-hidden bg-opacity-20 border-black-100">
