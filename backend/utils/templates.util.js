...
const chooseEmailVerificationDarkTemplate = async function ({ user_name = "", redirect_uri = "#", reply_mail = meta.emails.reply_email }) {
	try {
		let html = (await new Promise((resolve, reject) => {
...
const choosePasswordResetDarkTemplate = async function ({ user_name = "", dismiss_uri = "#", redirect_uri = "#", reply_mail = meta.emails.reply_email }) {
	try {
		let html = (await new Promise((resolve, reject) => {
